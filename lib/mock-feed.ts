...
export const foodCard: FoodDecisionCardData = {
  ...
  sceneLabel: "今晚 19:12",
  visual: {
    src: "/images/generated/card-food-decision.png",
    alt: "下班后的晚餐选择：米饭、热汤和微辣菜品摆在干净餐桌上",
    prompt: "Realistic 16:9 AI card cover for an after-work dinner decision scene with warm light, rice, soup, and spicy comfort food.",
  },
...
export const microTripCard: MicroTripCardData = {
  ...
  sceneLabel: "周末 16:12",
  visual: {
    src: "/images/generated/card-micro-trip.png",
    alt: "阴天上海街角、咖啡和河边步道组成的轻量城市散步场景",
    prompt: "Realistic 16:9 AI card cover for a calm Shanghai city walk with coffee, riverside path, plane trees, and soft cloudy light.",
  },
...
export const sportsCard: SportsPreMatchCardData = {
  ...
  visual: {
    src: "/images/generated/card-sports-prematch.png",
    alt: "足球、战术板和球场灯光构成的赛前分析场景",
    prompt: "Realistic 16:9 AI card cover for a football pre-match insight scene with a tactical board, pitch edge, and stadium lights.",
  },
...
export const recoveryCard: RecoveryCardData = {
  ...
  visual: {
    src: "/images/generated/card-recovery.png",
    alt: "床边小灯、耳机和半杯水组成的下班后低刺激恢复角落",
    prompt: "Realistic 16:9 AI card cover for a quiet after-work recovery routine with bedside lamp, earbuds, water, and soft evening light.",
  },
...
export const mockFeedItems: FeedItem[] = [
  {
    ...
    posterTone: "food",
    poster: {
      src: "/images/generated/video-food-night-noodles.png",
      alt: "深夜街头小面摊上一碗冒着热气的微辣小面",
      prompt: "Realistic 9:16 short-video cover for late-night spicy noodles with warm street food lighting and lower UI-safe space.",
    },
    tags: ["深夜食堂", "小面", "下班"],
  ...
  foodCard,
  {
    ...
    posterTone: "trip",
    poster: {
      src: "/images/generated/video-shanghai-citywalk.png",
      alt: "阴天上海街角咖啡、河边步道和树影构成的城市散步封面",
      prompt: "Realistic 9:16 short-video cover for a Shanghai city walk with coffee, riverside path, overcast light, and UI-safe lower space.",
    },
    tags: ["散步", "城市逃逸", "周末"],
  ...
  microTripCard,
  {
    ...
    posterTone: "sports",
    poster: {
      src: "/images/generated/video-football-prematch.png",
      alt: "足球场边的足球、战术板和赛前灯光构成的分析视频封面",
      prompt: "Realistic 9:16 short-video cover for football pre-match analysis with pitch edge, tactical board, stadium lights, and no team logos.",
    },
    tags: ["足球", "赛前", "看点"],
