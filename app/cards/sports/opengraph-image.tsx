...
export default function SportsOpengraphImage() {
  const colors = toneTokens.sports.sceneColors;
  const issue = toneTokens.sports.issueNumber;
  const subtitle =
    sportsDetail.kicker ?? sportsDetail.description.slice(0, 60);
    ...
    (
      ...
      >
        ...
        >
          ...
          <div>Issue {issue} · Pre-Match Lab</div>
        </div>
      </div>
    ),
    size,
