...
export default function TripOpengraphImage() {
  const colors = toneTokens.trip.sceneColors;
  const issue = toneTokens.trip.issueNumber;
  const subtitle =
    tripDetail.kicker ?? tripDetail.description.slice(0, 60);
    ...
    (
      ...
      >
        ...
        >
          ...
          <div>Issue {issue} · Micro Trip</div>
        </div>
      </div>
    ),
    size,
