...
export const alt = "3 小时城市逃逸生成器 · Tonight Lab";

export default function TripOgImage() {
  const tokens = toneTokens.trip;
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", justifyContent: "space-between", fontSize: 18, opacity: 0.78 }}>
          <span>tonight-lab.app / cards / trip</span>
